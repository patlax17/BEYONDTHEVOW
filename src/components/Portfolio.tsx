...
const portfolioItems = [
    {
        id: 1,
        title: "A South Asian Wedding",
        location: "United States",
        category: "Cultural Wedding",
        year: "2024",
        description:
            "An elegant fusion of tradition and modern luxury, with intricate embroidery, pearl jewelry, and a breathtaking ceremonial setting.",
        image: "/portfolio-01.jpg",
    },
    {
        id: 2,
        title: "A Garden Romance",
        location: "United States",
        category: "Full Planning & Design",
        year: "2024",
        description:
            "A golden-hour celebration with a sweeping ballgown and lush garden backdrop, designed to feel timeless and effortless.",
    ...
    },
    {
        ...
        year: "2024",
        description:
            "A show-stopping mermaid gown against an ornate architectural backdrop, capturing the drama and grandeur of luxury bridal.",
        image: "/portfolio-03.jpg",
    },
    {
        id: 4,
        title: "Bridal Party Moment",
        location: "United States",
        category: "Wedding Coordination",
        year: "2024",
        description:
            "Twelve bridesmaids, one stunning bride, and a venue filled with cascading white florals. A coordinated vision executed flawlessly.",
